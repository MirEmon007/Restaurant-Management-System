...
def Ref():
    ...
    costofmeal = "BDT.",str('%.2f'% (costoffries +  costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks))
    ...
    OverAllCost="BDT.",str( PayTax + Totalcost + Ser_Charge)
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By Mir Asif J Emon",bd=2,relief=SUNKEN)
